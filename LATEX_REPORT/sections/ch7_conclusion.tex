...
$0.12\,\mathrm{mm\,day^{-1}}$, which is what a smoothed reference scored against a smoothed,
interpolated truth would be expected to do.
...
Five limitations bound what the results above can claim, and three directions for future work follow from them.
