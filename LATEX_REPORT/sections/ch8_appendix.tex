...
is the opposite convention to every other importance figure in this work. The normalisation is what
makes the comparison possible at all, since the surface models carry their whole importance in one
...
Bernoulli--Gamma CRPS, which every run reports whatever it was trained on, and which is what the
